from .base_model import UnetModel, DeepLabV3PlusModel,UnetPlusPlus, DeepLabV3PlusModel_channel0, DeepLabV3PlusModel_LoRA
...
class ModelSelector():
    ...
    def __init__(self) -> None:
        self.model_classes = {
            ...
            "DeepLabV3PlusModel_LoRA": DeepLabV3PlusModel_LoRA
        }

    
    def get_model(self, model_name, lora_use, lora_config, **model_parameter):
        ...
        return self.model_classes.get(model_name, None)(lora_use, lora_config, **model_parameter)